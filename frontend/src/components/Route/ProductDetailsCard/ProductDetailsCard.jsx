    ...
    <div className="bg-white">
      {data ? (
        <div className="fixed w-full h-screen top-0 left-0 bg-[#00000030]  z-40 flex  items-center justify-center">
          <div className=" w-[90%]  800px:w-[60%] h-[90vh] overflow-scroll h-[75vh] bg-white rounded-md shadow-sm relative p-4">
            <RxCross1
              size={30}
              className="absoulte right-3 top-3 z-50"
            ...
            <div className="block w-full 800px:flex">
              <div className="w-full 800px:w-[50%]">
                ...
                <h5 className="text-[red] text-[16px] mt-5">({data.total_sell}) Sold Out</h5>
              </div>
              <div className="w-full 800px:w-[50%] pt-5 pl-[5px] pr-[5px]">
                <h1 className={`${styles.productTitle} text-[20[x]]`}>
                  {data.name}
                </h1>
                ...
                <div className="flex item-center mt-12 justify-between pr-3">
                  <div>
